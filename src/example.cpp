...
#ifndef WIN32
    bciinterface::ROSBackground bg(nh, "/camera/rgb/image_raw", wwidth, wheight, iwidth, iheight);
    iface.SetBackground(&bg);
#endif

#ifndef WIN32
    BLORTObject * obj = new BLORTObject("Pringles", ros::package::getPath("blort_ros") + "/Resources/ply/Pringles.ply", sf::Color(255, 0, 0, 255), 1, 60, wwidth, wheight, iwidth, iheight, bomanager);
#else
    BLORTObject * obj = new BLORTObject("can", "C:/devel/share/blort_ros/Resources/ply/Pringles.ply", sf::Color(255, 0, 0, 255), 1, 60, wwidth, wheight, iwidth, iheight, bomanager);
#endif
    iface.AddObject(obj);
